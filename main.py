...
class Robot():
    def __init__(self, sensors):
        ...
        #self.pausing_thread = threading.Thread(target=self.picked_up)
    ...
    def user_input(self):
        ...
        if (command == 'help' or command == 'h'): #works
            ...
            print("\tExplore/e - Explores map without a target")
            ...
            print("\tclear - Clears the map when prompted. Resets with new, blank map")
        
        elif (command == 'pause'): #works
            print("Pausing at the next intersection")
            self.pause_driving = True
        elif (command == 'explore' or command =='e'): #works
        ...
        elif (command == 'clear'): #works
            print("Deleting the map...")
            with open('map.pickle', 'wb') as filename:
